...
public final class Video: Codable {
    ...
    public final class Likes: Codable {
        ...
        public init(Count: Int64? = nil, UserLikes: VkFlag? = nil) {
            self.Count = Count
    ...
    public init(id: Int64? = nil, ownerId: Int64? = nil, title: String? = nil, description: String? = nil, duration: Int64? = nil, image: [Image]? = nil, firstFrame: [FirstFrame]? = nil, date: UInt64? = nil, addingDate: UInt64? = nil, views: Int64? = nil, localViews: Int64? = nil, comments: Int64? = nil, player: String? = nil, platform: String? = nil, canEdit: Int64? = nil, canAdd: VkFlag? = nil, isPrivate: Int64? = nil, accessKey: AccessKey? = nil, processing: Int64? = nil, isFavorite: IsFavorite? = nil, canComment: VkFlag? = nil, canLike: VkFlag? = nil, canRepost: VkFlag? = nil, canSubscribe: VkFlag? = nil, canAddToFaves: VkFlag? = nil, canAttachLink: VkFlag? = nil, width: Int64? = nil, height: Int64? = nil, userId: Int64? = nil, converting: VkFlag? = nil, added: VkFlag? = nil, isSubscribed: VkFlag? = nil, repeat: Int64? = nil, type: String? = nil, balance: Int64? = nil, liveStatus: String? = nil, live: Int64? = nil, upcoming: Int64? = nil, spectators: Int64? = nil, likes: Likes? = nil, reposts: Reposts? = nil) {
        self.id = id
